...
echo "----------------------------"
echo "This template will create an SSL certificate for WWW.$domain and redirect HTTP and HTTPS traffic to the root domain ($domain)."
echo "----------------------------"
...
if [[ "$confirmation" =~ ^[Yy][Ee]?[Ss]?$ ]]; then
  ...
  wget -O redirect-www-to-root-template.yml https://raw.githubusercontent.com/cbschuld/aws-cf-redirect-www-to-root/main/redirect-www-to-root.yml
  ...
  rm -f redirect-www-to-root-template.yml
